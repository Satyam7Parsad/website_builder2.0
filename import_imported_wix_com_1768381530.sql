-- Import Scraped Template: imported_wix_com_1768381530
-- Generated: 2026-01-14 14:37:14
...
-- psql -d website_builder < imported_wix_com_1768381530.sql
--
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'imported_wix_com_1768381530';
...
-- Template name: imported_wix_com_1768381530
-- Total sections: 0
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'imported_wix_com_1768381530';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'imported_wix_com_1768381530');

-- Import Scraped Template: test_paragraphs_demo
-- Generated: 2026-01-15 14:09:51
-- Source: http://localhost:8888/test_gradients.html
-- Sections: 6
--
-- Run this script to import the template into PostgreSQL:
-- psql -d website_builder < test_paragraphs_demo.sql
--
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'test_paragraphs_demo';
    ...
    INSERT INTO sections (
        ...
        '{"paragraphs": [{"text": "Testing gradient rendering in Website Builder", "fontSize": 24, "fontWeight": 400, "color": "rgb(255, 255, 255)", "fontFamily": "-apple-system, \"system-ui\", \"Segoe UI\", Roboto, sans-serif"}]}',
    ...
    INSERT INTO sections (
        ...
        '{"paragraphs": [{"text": "This section uses a 135deg diagonal gradient from purple to blue", "fontSize": 16, "fontWeight": 400, "color": "rgb(255, 255, 255)", "fontFamily": "-apple-system, \"system-ui\", \"Segoe UI\", Roboto, sans-serif"}]}',
    ...
    INSERT INTO sections (
        ...
        '{"paragraphs": [{"text": "This section uses a left-to-right gradient from pink to yellow", "fontSize": 16, "fontWeight": 400, "color": "rgb(255, 255, 255)", "fontFamily": "-apple-system, \"system-ui\", \"Segoe UI\", Roboto, sans-serif"}]}',
    ...
    INSERT INTO sections (
        ...
        '{"paragraphs": [{"text": "This section uses a radial gradient from the center", "fontSize": 16, "fontWeight": 400, "color": "rgb(255, 255, 255)", "fontFamily": "-apple-system, \"system-ui\", \"Segoe UI\", Roboto, sans-serif"}]}',
    ...
    INSERT INTO sections (
        ...
        FALSE,
        '{"button": {"borderRadius": "0px", "borderWidth": "0px", "borderColor": "rgb(0,0,0)", "boxShadow": "none", "padding": "10px 20px", "textTransform": "none", "letterSpacing": "normal"}, "section": {"borderRadius": "0px", "boxShadow": "none", "border": "none", "opacity": "1", "backgroundImage": "none", "backgroundSize": "auto", "filter": "none", "transform": "none", "textShadow": "none", "lineHeight": "normal", "letterSpacing": "normal"}}',
        '{"paragraphs": [{"text": "Footer with cyan gradient", "fontSize": 16, "fontWeight": 400, "color": "rgb(255, 255, 255)", "fontFamily": "-apple-system, \"system-ui\", \"Segoe UI\", Roboto, sans-serif"}]}',
        '{"padding": {"top": "60px", "right": "60px", "bottom": "60px", "left": "60px"}, "flexbox": {"display": "block", "flexDirection": "row", "justifyContent": "normal", "alignItems": "normal", "gap": "0px"}, "grid": {"gridTemplateColumns": "none", "gridTemplateRows": "none"}, "background": {"backgroundPosition": "0% 0%", "backgroundRepeat": "repeat", "backgroundSize": "auto", "backgroundImage": "none"}, "position": {"position": "static", "top": "auto", "left": "auto", "right": "auto", "bottom": "auto", "zIndex": "auto"}, "typography": {"fontFamily": "-apple-system, \"system-ui\", \"Segoe UI\", Roboto, sans-serif"}}'
    );
...
-- Template name: test_paragraphs_demo
-- Total sections: 6
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'test_paragraphs_demo';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'test_paragraphs_demo');

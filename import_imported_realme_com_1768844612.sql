-- Import Scraped Template: imported_realme_com_1768844612
-- Generated: 2026-01-19 23:13:59
-- Source: Unknown
-- Sections: 20
--
-- Run this script to import the template into PostgreSQL:
-- psql -d website_builder < imported_realme_com_1768844612.sql
--
...
VALUES (
    'imported_realme_com_1768844612',
    'Imported from  - Metadata: {"url": "", "scraped_date": "2026-01-19T23:13:59.886321", "forms": [], "social_links": [], "seo_data": {}, "custom_fonts": [], "advanced_css": {}, "typography_system": {}, "grid_system": {}, "responsive_layouts": {}}',  -- Limit to 5000 chars
    'Imported Realme Com 1768844612',
    '2026-01-19 23:13:59'
);
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'imported_realme_com_1768844612';
...
-- Template name: imported_realme_com_1768844612
-- Total sections: 20
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'imported_realme_com_1768844612';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'imported_realme_com_1768844612');

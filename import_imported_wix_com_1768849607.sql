-- Import Scraped Template: imported_wix_com_1768849607
-- Generated: 2026-01-20 00:39:06
-- Source: Unknown
-- Sections: 1
--
-- Run this script to import the template into PostgreSQL:
-- psql -d website_builder < imported_wix_com_1768849607.sql
--
...
VALUES (
    'imported_wix_com_1768849607',
    'Imported from  - Metadata: {"url": "", "scraped_date": "2026-01-20T00:39:06.906163", "forms": [], "social_links": [], "seo_data": {}, "custom_fonts": [], "advanced_css": {}, "typography_system": {}, "grid_system": {}, "responsive_layouts": {}}',  -- Limit to 5000 chars
    'Imported Wix Com 1768849607',
    '2026-01-20 00:39:06'
);
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'imported_wix_com_1768849607';
...
-- Template name: imported_wix_com_1768849607
-- Total sections: 1
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'imported_wix_com_1768849607';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'imported_wix_com_1768849607');

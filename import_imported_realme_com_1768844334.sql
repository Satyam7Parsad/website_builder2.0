-- Import Scraped Template: imported_realme_com_1768844334
-- Generated: 2026-01-19 23:09:21
-- Source: Unknown
-- Sections: 20
--
-- Run this script to import the template into PostgreSQL:
-- psql -d website_builder < imported_realme_com_1768844334.sql
--
...
VALUES (
    'imported_realme_com_1768844334',
    'Imported from  - Metadata: {"url": "", "scraped_date": "2026-01-19T23:09:21.135977", "forms": [], "social_links": [], "seo_data": {}, "custom_fonts": [], "advanced_css": {}, "typography_system": {}, "grid_system": {}, "responsive_layouts": {}}',  -- Limit to 5000 chars
    'Imported Realme Com 1768844334',
    '2026-01-19 23:09:21'
);
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'imported_realme_com_1768844334';
...
-- Template name: imported_realme_com_1768844334
-- Total sections: 20
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'imported_realme_com_1768844334';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'imported_realme_com_1768844334');

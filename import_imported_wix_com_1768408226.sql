-- Import Scraped Template: imported_wix_com_1768408226
-- Generated: 2026-01-14 22:02:09
...
-- psql -d website_builder < imported_wix_com_1768408226.sql
--
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'imported_wix_com_1768408226';
...
-- Template name: imported_wix_com_1768408226
-- Total sections: 0
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'imported_wix_com_1768408226';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'imported_wix_com_1768408226');

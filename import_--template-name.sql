-- Import Scraped Template: --template-name
-- Generated: 2026-01-20 00:00:37
-- Source: Unknown
-- Sections: 4
--
-- Run this script to import the template into PostgreSQL:
-- psql -d website_builder < --template-name.sql
--
...
VALUES (
    '--template-name',
    'Imported from  - Metadata: {"url": "", "scraped_date": "2026-01-20T00:00:37.713579", "forms": [], "social_links": [], "seo_data": {}, "custom_fonts": [], "advanced_css": {}, "typography_system": {}, "grid_system": {}, "responsive_layouts": {}}',  -- Limit to 5000 chars
    '--Template-Name',
    '2026-01-20 00:00:37'
);
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = '--template-name';
...
-- SELECT * FROM templates WHERE template_name = '--template-name';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = '--template-name');

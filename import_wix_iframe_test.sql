-- Import Scraped Template: wix_iframe_test
-- Generated: 2026-01-20 03:07:13
...
-- psql -d website_builder < wix_iframe_test.sql
--
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'wix_iframe_test';
    ...
    INSERT INTO sections (
        ...
        3,
        'none',
        'scraped_images/wix_iframe_test/img_4.jpg',
        TRUE,
...
-- Template name: wix_iframe_test
-- Total sections: 1
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'wix_iframe_test';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'wix_iframe_test');
...
WHERE template_id = (SELECT id FROM templates WHERE template_name = 'wix_iframe_test')
  AND section_order = 0;

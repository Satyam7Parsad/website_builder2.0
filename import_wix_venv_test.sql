-- Import Scraped Template: wix_venv_test
-- Generated: 2026-01-20 03:02:01
...
-- psql -d website_builder < wix_venv_test.sql
--
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'wix_venv_test';
    ...
    INSERT INTO sections (
        ...
        3,
        'none',
        'scraped_images/wix_venv_test/img_1.jpg',
        TRUE,
...
-- Template name: wix_venv_test
-- Total sections: 1
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'wix_venv_test';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'wix_venv_test');
...
WHERE template_id = (SELECT id FROM templates WHERE template_name = 'wix_venv_test')
  AND section_order = 0;

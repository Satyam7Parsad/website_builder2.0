-- Import Scraped Template: wix_template_test
-- Generated: 2026-01-20 02:57:00
...
-- psql -d website_builder < wix_template_test.sql
--
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'wix_template_test';
    ...
    INSERT INTO sections (
        ...
        3,
        'none',
        'scraped_images/wix_template_test/img_5.jpg',
        TRUE,
...
-- Template name: wix_template_test
-- Total sections: 1
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'wix_template_test';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'wix_template_test');
...
WHERE template_id = (SELECT id FROM templates WHERE template_name = 'wix_template_test')
  AND section_order = 0;

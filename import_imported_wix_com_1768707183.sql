-- Import Scraped Template: imported_wix_com_1768707183
-- Generated: 2026-01-18 09:11:57
...
-- psql -d website_builder < imported_wix_com_1768707183.sql
--
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'imported_wix_com_1768707183';
...
-- Template name: imported_wix_com_1768707183
-- Total sections: 0
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'imported_wix_com_1768707183';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'imported_wix_com_1768707183');

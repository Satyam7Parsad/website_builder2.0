-- Import Scraped Template: imported_wix_com_1768857098
-- Generated: 2026-01-20 02:43:56
-- Source: Unknown
-- Sections: 1
--
-- Run this script to import the template into PostgreSQL:
-- psql -d website_builder < imported_wix_com_1768857098.sql
--
...
VALUES (
    'imported_wix_com_1768857098',
    'Imported from  - Metadata: {"url": "", "scraped_date": "2026-01-20T02:43:56.783497", "forms": [], "social_links": [], "seo_data": {}, "custom_fonts": [], "advanced_css": {}, "typography_system": {}, "grid_system": {}, "responsive_layouts": {}}',  -- Limit to 5000 chars
    'Imported Wix Com 1768857098',
    '2026-01-20 02:43:56'
);
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'imported_wix_com_1768857098';
    ...
    INSERT INTO sections (
        ...
        3,
        '',
        '//static.wixstatic.com/media/6b32a101-4078-4c4a-9c84-c55c222d2a54.png',
        FALSE,
...
-- Template name: imported_wix_com_1768857098
-- Total sections: 1
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'imported_wix_com_1768857098';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'imported_wix_com_1768857098');

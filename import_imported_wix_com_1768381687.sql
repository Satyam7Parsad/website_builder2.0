-- Import Scraped Template: imported_wix_com_1768381687
-- Generated: 2026-01-14 14:39:51
...
-- psql -d website_builder < imported_wix_com_1768381687.sql
--
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'imported_wix_com_1768381687';
...
-- Template name: imported_wix_com_1768381687
-- Total sections: 0
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'imported_wix_com_1768381687';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'imported_wix_com_1768381687');

-- Import Scraped Template: test_fix
-- Generated: 2026-01-19 23:12:26
-- Source: Unknown
-- Sections: 1
--
-- Run this script to import the template into PostgreSQL:
-- psql -d website_builder < test_fix.sql
--
...
VALUES (
    'test_fix',
    'Imported from  - Metadata: {"url": "", "scraped_date": "2026-01-19T23:12:26.158341", "forms": [], "social_links": [], "seo_data": {}, "custom_fonts": [], "advanced_css": {}, "typography_system": {}, "grid_system": {}, "responsive_layouts": {}}',  -- Limit to 5000 chars
    'Test Fix',
    '2026-01-19 23:12:26'
);
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'test_fix';
...
-- Template name: test_fix
-- Total sections: 1
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'test_fix';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'test_fix');

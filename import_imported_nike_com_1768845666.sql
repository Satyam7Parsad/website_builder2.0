-- Import Scraped Template: imported_nike_com_1768845666
-- Generated: 2026-01-19 23:31:37
-- Source: Unknown
-- Sections: 20
--
-- Run this script to import the template into PostgreSQL:
-- psql -d website_builder < imported_nike_com_1768845666.sql
--
...
VALUES (
    'imported_nike_com_1768845666',
    'Imported from  - Metadata: {"url": "", "scraped_date": "2026-01-19T23:31:37.069647", "forms": [], "social_links": [], "seo_data": {}, "custom_fonts": [], "advanced_css": {}, "typography_system": {}, "grid_system": {}, "responsive_layouts": {}}',  -- Limit to 5000 chars
    'Imported Nike Com 1768845666',
    '2026-01-19 23:31:37'
);
...
BEGIN
    SELECT id INTO template_id_var FROM templates WHERE template_name = 'imported_nike_com_1768845666';
...
-- Template name: imported_nike_com_1768845666
-- Total sections: 20
--
-- To verify the import:
-- SELECT * FROM templates WHERE template_name = 'imported_nike_com_1768845666';
-- SELECT COUNT(*) FROM sections WHERE template_id = (SELECT id FROM templates WHERE template_name = 'imported_nike_com_1768845666');
